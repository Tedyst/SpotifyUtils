...
func securityHeaders(h http.Handler) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if !(*config.Debug) {
			w.Header().Set("Content-Security-Policy", "default-src 'none'; manifest-src 'self'; connect-src 'self' https://o557174.ingest.sentry.io https://sentry.io; img-src * data:; script-src https://o557174.ingest.sentry.io https://sentry.io https://storage.googleapis.com https://unpkg.com 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://unpkg.com; base-uri 'self'; report-uri https://o557174.ingest.sentry.io/api/5689078/security/?sentry_key=a38da28ff45041828f3ee7f714af0527; font-src https://fonts.gstatic.com https://use.typekit.net; worker-src https://spotify.stoicatedy.ovh https://spotify.tedyst.ro;")
		}
